            ...
            try
            {
                ...
                else
                {
                    var result = new RequestResult
                                 {
                                     Count = peopleNode.Attribute("count") == null
                                             ? 0
                                             : Int32.Parse(peopleNode.Attribute("count").Value),
                                     Total = peopleNode.Attribute("total") == null
                                             ? 0
                                             : Int32.Parse(peopleNode.Attribute("total").Value),
                                     Start = peopleNode.Attribute("start") == null
                                             ? 0
                                             : Int32.Parse(peopleNode.Attribute("start").Value)
                                 };
